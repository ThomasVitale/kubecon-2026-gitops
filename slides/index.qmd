...
One Knative Service — Flagger creates the canary variant with **different configuration**
...
<!-- Build 1: Prometheus scrapes gen_ai_calls_total -->
<!-- Build 2: Flagger runs PromQL every 10s: (B thumbs_up %) - (A thumbs_up %) using story_name label -->
<!-- Build 3: Delta >= 5pp for 5 consecutive checks → advance traffic weight by 10% -->
<!-- Build 4: Traffic split progression: 90/10 → 80/20 → ... → 0/100 (~100s full rollout) -->
