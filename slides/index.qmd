...
<!-- TODO: Thomas builds Flagger slides -->
<!-- Canary config: 30s interval, threshold 10, stepWeights [20→100], ~4.5 min full rollout -->
<!-- PromQL uses story_name label, vector(0) cold-start, 2m rate window -->

::: {.notes}
THOMAS PRESENTS. Scene 5: The Decision — Flagger's Canary Logic. Thomas owns these slides.
:::
